...
def load_and_process_data():
    ...
    # Load the CSV file
    df = pd.read_csv('/Users/vincentwu/Desktop/BAP/data/tweets_105.AAPL_2025-09.csv')
...
def create_visualizations(df):
    ...
    output_dir = '/Users/vincentwu/Desktop/BAP/sentiment_result'
...
class SentimentScoreGenerator:
    ...
    def __init__(self, data_path=None):
        self.data_path = data_path or '/Users/vincentwu/Desktop/BAP/data/tweets_105.AAPL_2025-09.csv'
...
def main():
    ...
    if scores_df is not None:
        # Save results
        results_file = '/Users/vincentwu/Desktop/BAP/sentiment_scores.csv'

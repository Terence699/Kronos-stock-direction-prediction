...
from config import OUTPUT_DIR, ENSEMBLE_OUTPUT_DIR, COMBINED_SCORES, ENSEMBLE_RESULTS
...
class ResultsVisualizer:
    ...
    def __init__(self):
        ...
        # save ensemble plots under result/ensemble
        self.output_dir = str(ENSEMBLE_OUTPUT_DIR)
